...
ax2_1 = plot_analysis_forfig(fig2,3,2,1, bass_subset, finbeat_byP, tracklist, 'A', True, False)  # Bass acc no cutoff
ax2_1.set_title('Bass \n')
ax2_2 = plot_analysis_forfig(fig2,3,2,2, trout_subset, finbeat_byP, tracklist, 'A', True, False)  # Trout accel no cutoff
ax2_2.set_title('Trout \n')
ax2_3 = plot_analysis_forfig(fig2,3,2,3, bass_subset, finbeat_byP, tracklist, 'A', True, True)  # Bass accel cutoff
ax2_4 = plot_analysis_forfig(fig2,3,2,4, trout_subset, finbeat_byP, tracklist, 'A', True, True)  # Trout accel cutoff
ax2_5 = plot_analysis_forfig(fig2,3,2,5, bass_subset, finbeat_byP, tracklist, 'V', True, False)  # Bass inst velocity
ax2_6 = plot_analysis_forfig(fig2,3,2,6, trout_subset, finbeat_byP, tracklist, 'V', True, False)  # Trout inst. velocity
